  ...
  return (
    <div className="space-y-8 py-8 text-center">
      ...
      <div className="flex justify-center">
        <div className="bg-pf-success-subtle relative flex h-20 w-20 items-center justify-center rounded-full">
          <CheckCircle2 className="text-pf-success-fg h-10 w-10" strokeWidth={1.5} />
          <Sparkles
            className="text-pf-success-fg absolute -top-1 -right-1 h-6 w-6 animate-pulse"
            strokeWidth={1.5}
          />
        </div>
      </div>
      ...
      >
        <h2 className="text-pf-fg-default text-2xl font-bold">
      ...
      <div
        className={`bg-pf-canvas-emphasis rounded-lg p-4 text-left font-mono text-sm transition-all delay-300 duration-700 ${showContent ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
      >
      ...
      {/* What's Next */}
      <div
        className={`border-pf-border-default border p-4 text-left transition-all delay-500 duration-700 ${showContent ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
      >
        <h3 className="text-pf-fg-default font-mono text-sm font-semibold">What&apos;s next?</h3>
        <ul className="text-pf-fg-muted mt-3 space-y-2 font-mono text-xs">
      ...
      >
        ...
        <Link
          ...
          onClick={handleGoToDashboard}
          className="border-pf-border-default text-pf-fg-default hover:bg-pf-canvas-subtle inline-flex items-center justify-center gap-2 border px-6 py-3 font-mono text-sm transition-colors"
        >
          Go to Dashboard
      ...
      <p className="text-pf-fg-subtle font-mono text-xs">
        Need help? Check our{" "}
        <Link href="#" className="text-pf-accent-fg hover:underline">
          documentation
        </Link>{" "}
        or{" "}
        <Link href="#" className="text-pf-accent-fg hover:underline">
