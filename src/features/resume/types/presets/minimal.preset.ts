...
export const MINIMAL_CONFIG: ResumeStyleConfig = {
  version: "1.0.0",
  layout: {
    type: "single-column",
    paperSize: "a4",
  ...
  sections: [
    ...
    { id: "skills", visible: true, order: 3, column: "full-width", style: {} },
    { id: "education", visible: true, order: 4, column: "full-width", style: {} },
  ],
};
