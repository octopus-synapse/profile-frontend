...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer border-gh-border-default h-4 w-4 shrink-0 rounded border",
      ...
      "data-[state=checked]:bg-gh-accent-emphasis data-[state=checked]:border-gh-accent-emphasis data-[state=checked]:text-white",
      className
    )}
    {...props}
  >
