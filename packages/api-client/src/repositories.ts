...
export const userRepository = {
 ...
 async validateUsername(
  ...
  const response = await usersValidateUsername({ username } as never);
  // SDK returns void for data, validity determined by status code
...
export const onboardingRepository = {
 ...
 async getStatus(): Promise<unknown> {
  const response = await onboardingGetStatus();
  if (!isSuccess(response.status)) {
...
export const collaborationRepository = {
 ...
 async updateRole(
  ...
  const response = await collaborationUpdateRole(
   resumeId,
   collaboratorId,
   data as never,
  );
...
export const experienceRepository = createStubRepository(
...
export const certificationRepository = createStubRepository(
 "certificationRepository",
);
export const publicationRepository = createStubRepository(
