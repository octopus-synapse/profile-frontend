...
import type { ResumeAnalyticsGetBenchmark200Data } from './resumeAnalyticsGetBenchmark200Data';

export type ResumeAnalyticsGetBenchmark200 = ApiResponseDto & {
  data: ResumeAnalyticsGetBenchmark200Data;
};
