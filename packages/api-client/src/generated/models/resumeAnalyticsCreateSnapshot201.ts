...
import type { ResumeAnalyticsCreateSnapshot201Data } from './resumeAnalyticsCreateSnapshot201Data';

export type ResumeAnalyticsCreateSnapshot201 = ApiResponseDto & {
  data: ResumeAnalyticsCreateSnapshot201Data;
};
