 ...
 */
import type { ThemeResolvedConfigDataDtoConfig } from './themeResolvedConfigDataDtoConfig';

export interface ThemeResolvedConfigDataDto {
  /** @nullable */
  config: ThemeResolvedConfigDataDtoConfig;
}
