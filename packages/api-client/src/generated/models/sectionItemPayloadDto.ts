 ...
 */
import type { SectionItemPayloadDtoContent } from './sectionItemPayloadDtoContent';

export interface SectionItemPayloadDto {
  /** Content fields for the section item */
  content: SectionItemPayloadDtoContent;
}
