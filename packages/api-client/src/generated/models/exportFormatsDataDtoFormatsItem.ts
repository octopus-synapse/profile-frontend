 ...
 */
import type { ExportFormatsDataDtoFormatsItemFormat } from './exportFormatsDataDtoFormatsItemFormat';

export type ExportFormatsDataDtoFormatsItem = {
  format: ExportFormatsDataDtoFormatsItemFormat;
};
