 ...
 */
import type { ExportDataResponseDtoResumesItemSectionsItemItemsItem } from './exportDataResponseDtoResumesItemSectionsItemItemsItem';

export type ExportDataResponseDtoResumesItemSectionsItem = {
  sectionTypeKey: string;
  semanticKind: string;
  items: ExportDataResponseDtoResumesItemSectionsItemItemsItem[];
};
