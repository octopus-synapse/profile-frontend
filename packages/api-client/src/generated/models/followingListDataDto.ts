 ...
 */
import type { FollowingListDataDtoFollowing } from './followingListDataDtoFollowing';

export interface FollowingListDataDto {
  following: FollowingListDataDtoFollowing;
}
