...
import type { TechLanguagesListDataDto } from './techLanguagesListDataDto';

export type TechSkillsQuerySearchLanguages200 = ApiResponse & {
  data: TechLanguagesListDataDto;
};
