 ...
 */
import type { MecSyncHistoryDataDtoHistoryItem } from './mecSyncHistoryDataDtoHistoryItem';

export interface MecSyncHistoryDataDto {
  history: MecSyncHistoryDataDtoHistoryItem[];
}
