 ...
 */
import type { ImportJobDtoParsedDataSectionsItemItemsItem } from './importJobDtoParsedDataSectionsItemItemsItem';

export type ImportJobDtoParsedDataSectionsItem = {
  sectionTypeKey: string;
  items: ImportJobDtoParsedDataSectionsItemItemsItem[];
};
