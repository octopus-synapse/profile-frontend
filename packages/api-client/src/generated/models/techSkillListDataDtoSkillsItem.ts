 ...
 */
import type { TechSkillListDataDtoSkillsItemNiche } from './techSkillListDataDtoSkillsItemNiche';

export type TechSkillListDataDtoSkillsItem = {
  id: string;
  slug: string;
  nameEn: string;
  namePtBr: string;
  ...
  popularity: number;
  /** @nullable */
  niche: TechSkillListDataDtoSkillsItemNiche;
};
