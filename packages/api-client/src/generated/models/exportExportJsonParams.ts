 ...
 */
import type { ExportExportJsonFormat } from './exportExportJsonFormat';

export type ExportExportJsonParams = {
/**
 * JSON format (default: jsonresume)
 */
format?: ExportExportJsonFormat;
};
