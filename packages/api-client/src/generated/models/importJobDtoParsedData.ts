 ...
 */
import type { ImportJobDtoParsedDataPersonalInfo } from './importJobDtoParsedDataPersonalInfo';
import type { ImportJobDtoParsedDataSectionsItem } from './importJobDtoParsedDataSectionsItem';

export type ImportJobDtoParsedData = {
  personalInfo: ImportJobDtoParsedDataPersonalInfo;
  summary?: string;
  sections: ImportJobDtoParsedDataSectionsItem[];
};
