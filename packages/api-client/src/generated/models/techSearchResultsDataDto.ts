 ...
 */
import type { TechSearchResultsDataDtoResults } from './techSearchResultsDataDtoResults';

export interface TechSearchResultsDataDto {
  results: TechSearchResultsDataDtoResults;
}
