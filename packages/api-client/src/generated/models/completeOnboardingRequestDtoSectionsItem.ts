 ...
 */
import type { CompleteOnboardingRequestDtoSectionsItemItemsItem } from './completeOnboardingRequestDtoSectionsItemItemsItem';

export type CompleteOnboardingRequestDtoSectionsItem = {
  sectionTypeKey: string;
  items?: CompleteOnboardingRequestDtoSectionsItemItemsItem[];
  noData?: boolean;
};
