 ...
 */
import type { TechNichesListDataDtoNichesItem } from './techNichesListDataDtoNichesItem';

export interface TechNichesListDataDto {
  niches: TechNichesListDataDtoNichesItem[];
}
