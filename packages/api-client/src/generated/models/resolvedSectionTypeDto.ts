 ...
 */
import type { ResolvedSectionTypeDtoDefinition } from './resolvedSectionTypeDtoDefinition';
import type { ResolvedSectionTypeDtoFieldStyles } from './resolvedSectionTypeDtoFieldStyles';
import type { ResolvedSectionTypeDtoRenderHints } from './resolvedSectionTypeDtoRenderHints';
import type { ResolvedSectionTypeDtoUiSchema } from './resolvedSectionTypeDtoUiSchema';

export interface ResolvedSectionTypeDto {
  id: string;
  key: string;
  slug: string;
  semanticKind: string;
  ...
  definition: ResolvedSectionTypeDtoDefinition;
  /** @nullable */
  uiSchema: ResolvedSectionTypeDtoUiSchema;
  renderHints: ResolvedSectionTypeDtoRenderHints;
  fieldStyles: ResolvedSectionTypeDtoFieldStyles;
}
