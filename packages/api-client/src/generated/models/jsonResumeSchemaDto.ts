 ...
 */
import type { JsonResumeBasicsDto } from './jsonResumeBasicsDto';
import type { JsonResumeCertificateDto } from './jsonResumeCertificateDto';
import type { JsonResumeEducationDto } from './jsonResumeEducationDto';
import type { JsonResumeLanguageDto } from './jsonResumeLanguageDto';
import type { JsonResumeProjectDto } from './jsonResumeProjectDto';
import type { JsonResumeSkillDto } from './jsonResumeSkillDto';
import type { JsonResumeWorkDto } from './jsonResumeWorkDto';

export interface JsonResumeSchemaDto {
