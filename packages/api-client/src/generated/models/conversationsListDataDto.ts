 ...
 */
import type { ConversationsListDataDtoConversations } from './conversationsListDataDtoConversations';

export interface ConversationsListDataDto {
  conversations: ConversationsListDataDtoConversations;
}
