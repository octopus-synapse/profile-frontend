 ...
 */
import type { ShareAnalyticsEventsDataDtoEventsItem } from './shareAnalyticsEventsDataDtoEventsItem';

export interface ShareAnalyticsEventsDataDto {
  events: ShareAnalyticsEventsDataDtoEventsItem[];
}
