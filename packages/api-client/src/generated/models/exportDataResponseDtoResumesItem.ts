 ...
 */
import type { ExportDataResponseDtoResumesItemSectionsItem } from './exportDataResponseDtoResumesItemSectionsItem';

export type ExportDataResponseDtoResumesItem = {
  id: string;
  /** @nullable */
  title: string | null;
  /** @nullable */
  ...
  sections: ExportDataResponseDtoResumesItemSectionsItem[];
};
