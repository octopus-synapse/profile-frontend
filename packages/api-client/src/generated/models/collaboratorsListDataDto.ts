 ...
 */
import type { CollaboratorsListDataDtoCollaboratorsItem } from './collaboratorsListDataDtoCollaboratorsItem';

export interface CollaboratorsListDataDto {
  collaborators: CollaboratorsListDataDtoCollaboratorsItem[];
}
