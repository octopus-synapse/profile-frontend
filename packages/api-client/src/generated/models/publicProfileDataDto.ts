 ...
 */
import type { PublicProfileDataDtoResume } from './publicProfileDataDtoResume';
import type { PublicProfileDataDtoUser } from './publicProfileDataDtoUser';

export interface PublicProfileDataDto {
  user: PublicProfileDataDtoUser;
  /** @nullable */
  resume: PublicProfileDataDtoResume;
}
