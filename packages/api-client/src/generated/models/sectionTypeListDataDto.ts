 ...
 */
import type { SectionTypeListDataDtoItemsItem } from './sectionTypeListDataDtoItemsItem';

export interface SectionTypeListDataDto {
  items: SectionTypeListDataDtoItemsItem[];
  total: number;
  page: number;
  pageSize: number;
  totalPages: number;
