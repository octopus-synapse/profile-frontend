 ...
 */
import type { CollaboratorDataDtoCollaborator } from './collaboratorDataDtoCollaborator';

export interface CollaboratorDataDto {
  collaborator: CollaboratorDataDtoCollaborator;
}
