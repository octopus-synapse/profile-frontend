 ...
 */
import type { SpokenLanguagesListDataDtoLanguagesItem } from './spokenLanguagesListDataDtoLanguagesItem';

export interface SpokenLanguagesListDataDto {
  languages: SpokenLanguagesListDataDtoLanguagesItem[];
}
