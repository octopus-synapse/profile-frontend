 ...
 */
import type { TechSkillsListDataDtoSkillsItem } from './techSkillsListDataDtoSkillsItem';

export interface TechSkillsListDataDto {
  skills: TechSkillsListDataDtoSkillsItem[];
}
