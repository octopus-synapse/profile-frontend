 ...
 */
import type { GitHubSyncStatusResponseDtoStatus } from './gitHubSyncStatusResponseDtoStatus';

export interface GitHubSyncStatusResponseDto {
  status: GitHubSyncStatusResponseDtoStatus;
  progress: number;
  startedAt?: string;
  currentTask?: string;
}
