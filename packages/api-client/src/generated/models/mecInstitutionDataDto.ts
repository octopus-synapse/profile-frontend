 ...
 */
import type { MecInstitutionDataDtoInstitution } from './mecInstitutionDataDtoInstitution';

export interface MecInstitutionDataDto {
  /** @nullable */
  institution: MecInstitutionDataDtoInstitution;
}
