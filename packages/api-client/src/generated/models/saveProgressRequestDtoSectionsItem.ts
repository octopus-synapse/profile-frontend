 ...
 */
import type { SaveProgressRequestDtoSectionsItemItemsItem } from './saveProgressRequestDtoSectionsItemItemsItem';

export type SaveProgressRequestDtoSectionsItem = {
  sectionTypeKey: string;
  items?: SaveProgressRequestDtoSectionsItemItemsItem[];
  noData?: boolean;
};
