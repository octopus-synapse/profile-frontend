 ...
 */
import type { MessagesListDataDtoMessagesMessagesItemSender } from './messagesListDataDtoMessagesMessagesItemSender';

export type MessagesListDataDtoMessagesMessagesItem = {
  id: string;
  ...
  readAt: string | null;
  createdAt: string;
  sender: MessagesListDataDtoMessagesMessagesItemSender;
};
