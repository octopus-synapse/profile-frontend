...
export type ExportFormatsDataDtoFormatsItemFormat = typeof ExportFormatsDataDtoFormatsItemFormat[keyof typeof ExportFormatsDataDtoFormatsItemFormat];


export const ExportFormatsDataDtoFormatsItemFormat = {
  PDF: 'PDF',
  DOCX: 'DOCX',
  JSON: 'JSON',
} as const;
