...
import type { ResumeAnalyticsGetDashboard200Data } from './resumeAnalyticsGetDashboard200Data';

export type ResumeAnalyticsGetDashboard200 = ApiResponseDto & {
  data: ResumeAnalyticsGetDashboard200Data;
};
