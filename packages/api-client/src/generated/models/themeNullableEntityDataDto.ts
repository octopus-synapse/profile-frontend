 ...
 */
import type { ThemeNullableEntityDataDtoTheme } from './themeNullableEntityDataDtoTheme';

export interface ThemeNullableEntityDataDto {
  /** @nullable */
  theme: ThemeNullableEntityDataDtoTheme;
}
