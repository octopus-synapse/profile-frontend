 ...
 */
import type { TechLanguagesListDataDtoLanguagesItem } from './techLanguagesListDataDtoLanguagesItem';

export interface TechLanguagesListDataDto {
  languages: TechLanguagesListDataDtoLanguagesItem[];
}
