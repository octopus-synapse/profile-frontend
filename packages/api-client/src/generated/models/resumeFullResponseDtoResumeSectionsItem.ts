 ...
 */
import type { ResumeFullResponseDtoResumeSectionsItemItemsItem } from './resumeFullResponseDtoResumeSectionsItemItemsItem';
import type { ResumeFullResponseDtoResumeSectionsItemSectionType } from './resumeFullResponseDtoResumeSectionsItemSectionType';

export type ResumeFullResponseDtoResumeSectionsItem = {
  id: string;
  order: number;
  visible: boolean;
  sectionType: ResumeFullResponseDtoResumeSectionsItemSectionType;
  items: ResumeFullResponseDtoResumeSectionsItemItemsItem[];
};
