 ...
 */
import type { AcceptConsentResponseDtoConsentDocumentType } from './acceptConsentResponseDtoConsentDocumentType';

export type AcceptConsentResponseDtoConsent = {
  id: string;
  userId: string;
  documentType: AcceptConsentResponseDtoConsentDocumentType;
  version: string;
  acceptedAt: string;
  ipAddress: string;
  userAgent: string;
