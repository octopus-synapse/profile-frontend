 ...
 */
import type { ApplyThemeToResumeRequestDtoCustomizations } from './applyThemeToResumeRequestDtoCustomizations';

export interface ApplyThemeToResumeRequestDto {
  resumeId: string;
  themeId: string;
  customizations?: ApplyThemeToResumeRequestDtoCustomizations;
}
