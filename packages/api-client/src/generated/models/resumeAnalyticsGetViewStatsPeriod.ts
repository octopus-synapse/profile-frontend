...
export type ResumeAnalyticsGetViewStatsPeriod = typeof ResumeAnalyticsGetViewStatsPeriod[keyof typeof ResumeAnalyticsGetViewStatsPeriod];


export const ResumeAnalyticsGetViewStatsPeriod = {
  day: 'day',
  week: 'week',
  month: 'month',
  year: 'year',
