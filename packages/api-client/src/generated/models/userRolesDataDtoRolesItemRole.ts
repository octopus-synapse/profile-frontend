...
export type UserRolesDataDtoRolesItemRole = typeof UserRolesDataDtoRolesItemRole[keyof typeof UserRolesDataDtoRolesItemRole];


export const UserRolesDataDtoRolesItemRole = {
  USER: 'USER',
  ADMIN: 'ADMIN',
} as const;
