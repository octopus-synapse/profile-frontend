 ...
 */
import type { OnboardingSessionDtoStepsItemFieldsItem } from './onboardingSessionDtoStepsItemFieldsItem';

export type OnboardingSessionDtoStepsItem = {
  id: string;
  label: string;
  description: string;
  required: boolean;
  component: string;
  icon?: string;
  fields?: OnboardingSessionDtoStepsItemFieldsItem[];
  noDataLabel?: string;
  placeholder?: string;
  addLabel?: string;
