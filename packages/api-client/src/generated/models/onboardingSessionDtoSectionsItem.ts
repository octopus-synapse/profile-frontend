 ...
 */
import type { OnboardingSessionDtoSectionsItemItemsItem } from './onboardingSessionDtoSectionsItemItemsItem';

export type OnboardingSessionDtoSectionsItem = {
  sectionTypeKey: string;
  items?: OnboardingSessionDtoSectionsItemItemsItem[];
  noData?: boolean;
};
