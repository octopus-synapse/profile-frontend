 ...
 */
import type { ActivityListDataDtoActivities } from './activityListDataDtoActivities';

export interface ActivityListDataDto {
  activities: ActivityListDataDtoActivities;
}
