 ...
 */
import type { ConversationsListDataDtoConversationsConversationsItemLastMessage } from './conversationsListDataDtoConversationsConversationsItemLastMessage';
import type { ConversationsListDataDtoConversationsConversationsItemParticipant } from './conversationsListDataDtoConversationsConversationsItemParticipant';

export type ConversationsListDataDtoConversationsConversationsItem = {
  id: string;
  participant: ConversationsListDataDtoConversationsConversationsItemParticipant;
  /** @nullable */
  lastMessage: ConversationsListDataDtoConversationsConversationsItemLastMessage;
  unreadCount: number;
  createdAt: string;
  updatedAt: string;
};
