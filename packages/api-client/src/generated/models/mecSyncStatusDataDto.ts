 ...
 */
import type { MecSyncStatusDataDtoLastSync } from './mecSyncStatusDataDtoLastSync';
import type { MecSyncStatusDataDtoMetadata } from './mecSyncStatusDataDtoMetadata';

export interface MecSyncStatusDataDto {
  isRunning: boolean;
  /** @nullable */
  metadata: MecSyncStatusDataDtoMetadata;
  /** @nullable */
  lastSync: MecSyncStatusDataDtoLastSync;
}
