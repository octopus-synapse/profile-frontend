 ...
 */
import type { OnboardingSectionItemDtoContent } from './onboardingSectionItemDtoContent';

export interface OnboardingSectionItemDto {
  /** Optional item ID */
  id?: string;
  /** Item content - structure depends on section type */
  content: OnboardingSectionItemDtoContent;
}
