 ...
 */
import type { SharedResumesListDataDtoSharedResumesItem } from './sharedResumesListDataDtoSharedResumesItem';

export interface SharedResumesListDataDto {
  sharedResumes: SharedResumesListDataDtoSharedResumesItem[];
}
