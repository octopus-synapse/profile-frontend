 ...
 */
import type { ResumeAnalyticsGetViewStatsPeriod } from './resumeAnalyticsGetViewStatsPeriod';

export type ResumeAnalyticsGetViewStatsParams = {
period: ResumeAnalyticsGetViewStatsPeriod;
startDate?: string;
endDate?: string;
};
