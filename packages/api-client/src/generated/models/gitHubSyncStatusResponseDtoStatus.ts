...
export type GitHubSyncStatusResponseDtoStatus = typeof GitHubSyncStatusResponseDtoStatus[keyof typeof GitHubSyncStatusResponseDtoStatus];


export const GitHubSyncStatusResponseDtoStatus = {
  IDLE: 'IDLE',
  RUNNING: 'RUNNING',
  COMPLETED: 'COMPLETED',
  FAILED: 'FAILED',
