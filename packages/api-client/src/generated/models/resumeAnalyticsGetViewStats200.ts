...
import type { ResumeAnalyticsGetViewStats200Data } from './resumeAnalyticsGetViewStats200Data';

export type ResumeAnalyticsGetViewStats200 = ApiResponseDto & {
  data: ResumeAnalyticsGetViewStats200Data;
};
