 ...
 */
import type { UserPreferencesDataDtoPreferences } from './userPreferencesDataDtoPreferences';

export interface UserPreferencesDataDto {
  preferences: UserPreferencesDataDtoPreferences;
}
