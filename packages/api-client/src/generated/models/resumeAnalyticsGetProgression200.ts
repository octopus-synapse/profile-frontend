...
import type { ResumeAnalyticsGetProgression200Data } from './resumeAnalyticsGetProgression200Data';

export type ResumeAnalyticsGetProgression200 = ApiResponseDto & {
  data: ResumeAnalyticsGetProgression200Data;
};
