 ...
 */
import type { ImportJsonDtoDataBasicsLocation } from './importJsonDtoDataBasicsLocation';
import type { ImportJsonDtoDataBasicsProfilesItem } from './importJsonDtoDataBasicsProfilesItem';

export type ImportJsonDtoDataBasics = {
  /** @minLength 1 */
  name: string;
  label?: string;
  email?: string;
  ...
  url?: string;
  summary?: string;
  location?: ImportJsonDtoDataBasicsLocation;
  profiles?: ImportJsonDtoDataBasicsProfilesItem[];
};
