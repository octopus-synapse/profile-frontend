 ...
 */
import type { UserFullPreferencesDataDtoPreferences } from './userFullPreferencesDataDtoPreferences';

export interface UserFullPreferencesDataDto {
  preferences: UserFullPreferencesDataDtoPreferences;
}
