 ...
 */
import type { MecCourseListDataDtoCoursesItem } from './mecCourseListDataDtoCoursesItem';

export interface MecCourseListDataDto {
  courses: MecCourseListDataDtoCoursesItem[];
}
