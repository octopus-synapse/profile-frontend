 ...
 */
import type { ImportJsonDtoDataBasics } from './importJsonDtoDataBasics';
import type { ImportJsonDtoDataCertificatesItem } from './importJsonDtoDataCertificatesItem';
import type { ImportJsonDtoDataEducationItem } from './importJsonDtoDataEducationItem';
import type { ImportJsonDtoDataLanguagesItem } from './importJsonDtoDataLanguagesItem';
...
export type ImportJsonDtoData = {
  ...
  skills?: ImportJsonDtoDataSkillsItem[];
  languages?: ImportJsonDtoDataLanguagesItem[];
  certificates?: ImportJsonDtoDataCertificatesItem[];
  projects?: ImportJsonDtoDataProjectsItem[];
};
