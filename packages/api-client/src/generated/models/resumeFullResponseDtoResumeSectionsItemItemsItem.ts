 ...
 */
import type { ResumeFullResponseDtoResumeSectionsItemItemsItemContent } from './resumeFullResponseDtoResumeSectionsItemItemsItemContent';

export type ResumeFullResponseDtoResumeSectionsItemItemsItem = {
  id: string;
  order: number;
  content?: ResumeFullResponseDtoResumeSectionsItemItemsItemContent;
};
