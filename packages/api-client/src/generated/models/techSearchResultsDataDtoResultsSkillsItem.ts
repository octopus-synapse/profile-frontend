 ...
 */
import type { TechSearchResultsDataDtoResultsSkillsItemNiche } from './techSearchResultsDataDtoResultsSkillsItemNiche';

export type TechSearchResultsDataDtoResultsSkillsItem = {
  id: string;
  slug: string;
  nameEn: string;
  namePtBr: string;
  ...
  popularity: number;
  /** @nullable */
  niche: TechSearchResultsDataDtoResultsSkillsItemNiche;
};
