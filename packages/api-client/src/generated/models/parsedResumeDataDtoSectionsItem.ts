 ...
 */
import type { ParsedResumeDataDtoSectionsItemItemsItem } from './parsedResumeDataDtoSectionsItemItemsItem';

export type ParsedResumeDataDtoSectionsItem = {
  sectionTypeKey: string;
  items: ParsedResumeDataDtoSectionsItemItemsItem[];
};
