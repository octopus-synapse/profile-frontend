 ...
 */
import type { MecInstitutionCoursesDataDtoCoursesItem } from './mecInstitutionCoursesDataDtoCoursesItem';

export interface MecInstitutionCoursesDataDto {
  courses: MecInstitutionCoursesDataDtoCoursesItem[];
}
