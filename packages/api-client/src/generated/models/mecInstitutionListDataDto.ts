 ...
 */
import type { MecInstitutionListDataDtoInstitutionsItem } from './mecInstitutionListDataDtoInstitutionsItem';

export interface MecInstitutionListDataDto {
  institutions: MecInstitutionListDataDtoInstitutionsItem[];
}
