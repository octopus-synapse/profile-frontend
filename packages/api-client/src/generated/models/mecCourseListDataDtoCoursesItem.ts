 ...
 */
import type { MecCourseListDataDtoCoursesItemInstitution } from './mecCourseListDataDtoCoursesItemInstitution';

export type MecCourseListDataDtoCoursesItem = {
  id: string;
  codigoCurso: number;
  nome: string;
  /** @nullable */
  ...
  institution: MecCourseListDataDtoCoursesItemInstitution;
};
