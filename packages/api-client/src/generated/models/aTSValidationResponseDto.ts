 ...
 */
import type { ATSValidationResponseDtoIssuesItem } from './aTSValidationResponseDtoIssuesItem';

export interface ATSValidationResponseDto {
  score: number;
  issues: ATSValidationResponseDtoIssuesItem[];
  suggestions: string[];
