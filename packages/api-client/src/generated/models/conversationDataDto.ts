 ...
 */
import type { ConversationDataDtoConversation } from './conversationDataDtoConversation';

export interface ConversationDataDto {
  conversation: ConversationDataDtoConversation;
}
