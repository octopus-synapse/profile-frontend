 ...
 */
import type { ResumeSectionsDataDtoSectionsItem } from './resumeSectionsDataDtoSectionsItem';

export interface ResumeSectionsDataDto {
  sections: ResumeSectionsDataDtoSectionsItem[];
}
