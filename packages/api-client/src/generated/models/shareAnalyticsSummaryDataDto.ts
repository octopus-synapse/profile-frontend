 ...
 */
import type { ShareAnalyticsSummaryDataDtoAnalytics } from './shareAnalyticsSummaryDataDtoAnalytics';

export interface ShareAnalyticsSummaryDataDto {
  analytics: ShareAnalyticsSummaryDataDtoAnalytics;
}
