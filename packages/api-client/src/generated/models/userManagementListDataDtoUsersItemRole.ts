...
export type UserManagementListDataDtoUsersItemRole = typeof UserManagementListDataDtoUsersItemRole[keyof typeof UserManagementListDataDtoUsersItemRole];


export const UserManagementListDataDtoUsersItemRole = {
  USER: 'USER',
  ADMIN: 'ADMIN',
} as const;
