...
export type ResumeAnalyticsGetBenchmarkExperienceLevel = typeof ResumeAnalyticsGetBenchmarkExperienceLevel[keyof typeof ResumeAnalyticsGetBenchmarkExperienceLevel];


export const ResumeAnalyticsGetBenchmarkExperienceLevel = {
  entry: 'entry',
  junior: 'junior',
  mid: 'mid',
  senior: 'senior',
