 ...
 */
import type { JsonResumeBasicsLocationDto } from './jsonResumeBasicsLocationDto';
import type { JsonResumeProfileDto } from './jsonResumeProfileDto';

export interface JsonResumeBasicsDto {
  name: string;
  label?: string;
  email?: string;
  phone?: string;
