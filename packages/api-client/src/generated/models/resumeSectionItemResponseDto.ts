 ...
 */
import type { ResumeSectionItemResponseDtoContent } from './resumeSectionItemResponseDtoContent';

export interface ResumeSectionItemResponseDto {
  id: string;
  order: number;
  content?: ResumeSectionItemResponseDtoContent;
}
