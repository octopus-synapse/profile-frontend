...
export function createSectionConfigRepository(client: HttpClient) {
  ...
  return {
    ...
    async toggleSection(resumeId: string, sectionId: string, visible: boolean) {
      return client.post(`${configUrl(resumeId)}/sections/${sectionId}/visibility`, {
        visible,
      });
    },
    ...
    async reorderSection(resumeId: string, sectionId: string, order: number) {
      return client.post(`${configUrl(resumeId)}/sections/${sectionId}/order`, { order });
    },
    ...
    async toggleItem(
      ...
      return client.post(`${configUrl(resumeId)}/sections/${sectionId}/items/visibility`, {
        itemId,
        visible,
      });
    },
    ...
    async reorderItem(
      ...
      return client.post(`${configUrl(resumeId)}/sections/${sectionId}/items/order`, {
        itemId,
        order,
      });
    },
...
export type SectionConfigRepository = ReturnType<typeof createSectionConfigRepository>;
