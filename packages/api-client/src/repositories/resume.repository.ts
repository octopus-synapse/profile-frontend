...
export function createResumeRepository(client: HttpClient) {
 return {
  ...
  async reorderExperiences(
   ...
   return client.patch<Experience[]>(
    `${BASE_URL}/${resumeId}/experiences/reorder`,
    { order }
   );
  },
  ...
  async updateEducation(
   ...
   return client.patch<Education>(
    `${BASE_URL}/${resumeId}/educations/${educationId}`,
    data
   );
  },
  ...
  async updateSkill(
   ...
   return client.patch<Skill>(
    `${BASE_URL}/${resumeId}/skills/${skillId}`,
    data
   );
  },
  ...
  async bulkAddSkills(
   ...
   return client.post<Skill[]>(`${BASE_URL}/${resumeId}/skills/bulk`, {
    skills,
   });
  },
  ...
  async updateLanguage(
   ...
   return client.patch<Language>(
    `${BASE_URL}/${resumeId}/languages/${languageId}`,
    data
   );
  },
  ...
  async addCertification(
   ...
   return client.post<Certification>(
    `${BASE_URL}/${resumeId}/certifications`,
    data
   );
  },
  ...
  async updateProject(
   ...
   return client.patch<Project>(
    `${BASE_URL}/${resumeId}/projects/${projectId}`,
    data
   );
  },
