 ...
 */
export function createSystemTheme(options: Omit<ThemeFactoryOptions, 'isSystem'> = {}): MockTheme {
 ...
 */
export function createThemes(count: number, options: ThemeFactoryOptions = {}): MockTheme[] {
