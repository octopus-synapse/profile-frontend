...
export function ThemePreview({ config, className = "" }: Props) {
 ...
 return (
  ...
  >
   {/* Mini resume layout */}
   <div
    className="flex h-full flex-col p-2 text-[4px]"
   ...
   >
    ...
    >
     <div
      className="mb-0.5 h-2 w-16 rounded-sm"
   ...
   <PreviewSection primaryColor={primaryColor}>
    <div className="space-y-0.5">
     <div
      ...
      style={{ backgroundColor: textColor + "60" }}
     />
     <div
...
function TwoColumnPreview({
 ...
 return (
  <div className="flex flex-1 gap-1">
   ...
   {/* Sidebar */}
   <div
    className="w-10 space-y-1.5 border-l pl-1"
...
function PreviewSection({
 ...
 return (
  <div>
   <div
    className="mb-0.5 h-0.5 w-8 rounded-sm"
    style={{ backgroundColor: primaryColor }}
   />
   {children}
  </div>
