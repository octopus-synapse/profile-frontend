			...
			<div className="h-full overflow-hidden rounded-2xl border-2 border-red-200 bg-white shadow-2xl">
				<div className="flex h-full">
					...
					<div className="w-2/5 bg-gradient-to-b from-purple-600 via-pink-500 to-orange-400 p-6">
						...
						<p className="mb-6 text-center text-sm font-bold text-white">
							Maria Santos
						</p>

						{/* Contact with icons */}
						<div className="mb-6 space-y-2">
							{["📧 maria@email.com", "📱 (11) 99999-9999", "📍 São Paulo"].map(
								(item) => (
									<div
										key={item}
		...
		>
			<div className="h-full overflow-hidden rounded-2xl border-2 border-emerald-200 bg-white p-8 shadow-2xl">
				...
				<div className="mt-4">
					...
					<p className="mt-1 text-xs leading-relaxed text-zinc-600">
						...
						Led teams of up to 8 engineers. Specialized in React, Node.js, and
						distributed systems.
					</p>
				</div>
			...
			<div className="absolute inset-0 flex items-center justify-center rounded-2xl">
				<div className="rotate-[-12deg] rounded-lg border-4 border-emerald-500 bg-white/95 px-8 py-4 shadow-lg">
					...
					<p className="mt-1 text-center text-sm text-emerald-400">
						ATS Score: 98%
					</p>
				</div>
			</div>
...
export function ComparisonSection() {
	...
	return (
		<section
			ref={ref}
			className="relative min-h-[150vh] bg-zinc-950 px-6 py-32"
		>
			{/* Sticky container */}
