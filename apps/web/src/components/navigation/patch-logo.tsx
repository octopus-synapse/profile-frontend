/**
 * PatchLogo - SVG logo component without link wrapper
 * Use this when you need just the logo image (e.g., in auth pages)
 */
...
export function PatchLogo({ className }: PatchLogoProps) {
  return (
    <svg viewBox="0 0 240 90" className={className} xmlns="http://www.w3.org/2000/svg">
