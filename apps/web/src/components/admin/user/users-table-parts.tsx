...
import type {
  UserManagementListDataDtoUsersItem,
  UserRolesDataDtoRolesItemRole,
...
interface UsersTableRowProps {
  user: UserManagementListDataDtoUsersItem;
  onRoleChange: (userId: string, newRole: UserRolesDataDtoRolesItemRole) => void;
