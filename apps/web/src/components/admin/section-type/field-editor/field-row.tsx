      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <Button
            ...
            size="xs"
            disabled={isFirst}
            aria-label={t('admin.sectionTypes.fields.moveUp')}
          ...
          <Button
            ...
            size="xs"
            disabled={isLast}
            aria-label={t('admin.sectionTypes.fields.moveDown')}
          ...
          <Button
            ...
            tone="danger"
            size="xs"
            aria-label={t('admin.sectionTypes.fields.remove')}
        ...
        <div className="flex items-end gap-4 pb-1">
          <div className="flex items-center gap-1.5">
            <Checkbox
              ...
              onCheckedChange={(v: boolean | 'indeterminate') => update({ required: v === true })}
            />
          ...
          <div className="flex items-center gap-1.5">
            <Checkbox
              ...
              onCheckedChange={(v: boolean | 'indeterminate') =>
                update({ nullable: v === true || undefined })
              }
            />
      ...
      {field.type === 'date' && (
        <div className="flex items-center gap-1.5">
          <Checkbox
            ...
            onCheckedChange={(v: boolean | 'indeterminate') =>
              updateMeta({ allowPresentFlag: v === true || undefined })
            }
          />
