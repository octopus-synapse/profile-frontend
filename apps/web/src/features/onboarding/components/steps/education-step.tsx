  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-1 font-mono text-xs">Add your educational background</p>
      </div>
          ...
          {isAdding ? (
            <div className="border-cyan-500/30 bg-white/5 space-y-4 border p-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  <label className="text-white mb-1 block font-mono text-xs">endDate</label>
                  <input
                    type="date"
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  className="text-cyan-400 h-4 w-4"
                />
                <span className="text-zinc-400 font-mono text-xs">Currently studying</span>
              </label>
